...
DMParticlePseudoScalar* DMParticlePseudoScalar::Definition(G4double MassIn, G4double epsilIn)
{
  if( theInstance ) {
    return theInstance;
  }
...
DMParticlePseudoScalar* DMParticlePseudoScalar::Definition()
{
  ...
  G4cout << "DMParticlePseudoScalar::Definition() : PseudoScalar is not yet defined by the proper method with arguments, exiting" << G4endl;
  exit(1);
}
